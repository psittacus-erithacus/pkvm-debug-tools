...
#if HYP_DEBUG_RAMLOG_DIRECT_PRINT
...
#else // HYP_DEBUG_RAMLOG_DIRECT_PRINT
...
#endif // HYP_DEBUG_RAMLOG_DIRECT_PRINT
 ...
 * @cont set true, if printing continues after output buffer is full
 * @return 1 if output buffer is full, 0 otherwise.*
 */
...
static inline int output_rlog(bool dump, bool cont) { return 0; }
